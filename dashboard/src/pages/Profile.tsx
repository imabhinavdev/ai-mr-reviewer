...
export function Profile() {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (fullName !== (user.fullName ?? '')) payload.fullName = fullName || undefined
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Account Information */}
      <ErrorBoundary sectionLabel="Profile form" message="This section failed to load.">
      <Card>
        <CardHeader
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-sm text-[var(--color-text-secondary)]">
              <p className="font-medium text-[var(--color-text)]">Profile photo</p>
              <p className="mt-0.5">Avatar can be updated when supported by your administrator.</p>
            </div>
          </div>
      ...
      {/* Security Settings */}
      <ErrorBoundary sectionLabel="Security settings" message="This section failed to load.">
      <Card>
        <CardHeader
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <div>
            ...
            <Button variant="secondary" size="sm" className="mt-2" onClick={scrollToPassword}>
      ...
      {/* Password Change */}
      <ErrorBoundary sectionLabel="Password section" message="This section failed to load.">
      ...
      <ErrorBoundary sectionLabel="Activity information" message="This section failed to load.">
      <Card>
        <CardHeader
        ...
        <dl className="grid gap-4 sm:grid-cols-2 text-sm">
          <div>
            <dt className="font-medium text-[var(--color-text-secondary)]">Last login</dt>
            <dd className="mt-0.5 text-[var(--color-text)]">
              {formatDate(user?.lastLoginAt)}
            </dd>
          </div>
          <div>
            <dt className="font-medium text-[var(--color-text-secondary)]">Account created</dt>
            <dd className="mt-0.5 text-[var(--color-text)]">
